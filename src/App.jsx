  ...
  return (
    <main>
      <div className="images">
        <img id="tomorrow" src="/background/tomorrow.png" alt="" />
        <img id="navy" src="/background/festival.png" alt="" />
        <img id="chicago" src="/background/chicago.png" alt="" />
        <img id="opera" src="/background/opera.png" alt="" />
        <img id="festival" src="/background/festival.png" alt="" />
        <img id="kennedy" src="/background/kennedy.png" alt="" />
        <img id="bouguessa" src="/background/bouguessa.png" alt="" />
        <img id="louises" src="/background/louises.png" alt="" />
        <img id="revelator" src="/background/revelator.png" alt="" />
      </div>
      <Canvas
        id="canvas-elem"
        style={{
      ...
      <section id="section-1">
        <nav>
          ...
          <div className="nav-elem">
            {" "}
            <h5>
              <i className="ri-arrow-drop-right-line"></i> Nuestro Showreel
            </h5>{" "}
          </div>
          <div className="nav-elem">
        ...
        <div className="bottom">
          ...
          <div className="right">
            <p className="p1">
              Dogstudio es un estudio creativo <br /> multidisciplinario que
              tiene lugar <br /> justo donde el arte, el diseño y la <br />{" "}
              tecnología se juntan.
            </p>
            <p className="p2">
              Tenemos la mirada fija en crear experiencias que le <br /> den a
              la gente de qué hablar, así como construir y <br /> enriquecer el
              valor estratégico de las marcas, la <br /> tecnología, el
              entretenimiento, el arte y la cultura
            </p>
            <ul>
              <li>
                <a href="">Facebook </a>
      ...
      <section id="section-2">
        <div className="titles">
          <div image-title="tomorrow" className="title">
            <small>2020 - Ongoing</small>
            <h1>Tomorrowland</h1>
          </div>

          <div image-title="navy" className="title">
            <small>2018 - Presente</small>
            <h1>Navy Pier</h1>
          </div>
          <div image-title="chicago" className="title">
            <small>2020 - Ongoing</small>
            <h1>MSI Chicago</h1>
          </div>
          <div image-title="opera" className="title">
            <small>2016 - Presente</small>
            <h1>Real Ópera de Valonia</h1>
          </div>
          <div image-title="festival" className="title">
            <small>2012 - Presente</small>
            <h1> KIKK Festival 2018</h1>
          </div>
          <div image-title="kennedy" className="title">
            <small>2017 - Presente </small>
            <h1>El Kennedy Center</h1>
          </div>
          <div image-title="bouguessa" className="title">
            <small>2017</small>
            <h1> Bouguessa</h1>
          </div>
          <div image-title="louises" className="title">
            <small>2016</small>
            <h1> This Was Louise’s Phone</h1>
          </div>
          <div image-title="revelator" className="title">
            <small>2016</small>
            <h1>Revelator</h1>
          </div>
        </div>
        ...
        <div className="top">
          <div className="left">
            <h3>
              ...
              <br /> Commodi, sint id? Perferendis <br /> modi doloribus fugiat?
            </h3>
          </div>
          <div className="right"></div>
        </div>
 ...
 <div className="bottom">
          ...
          <div className="right">
            <p>
              ...
              porro itaque totam nemo, fugit quam laboriosam magnam nobis, quia
              repellat nam tempore animi, error numquam rem consequatur. Facere
              minus consequatur illo et. Illo ea, voluptas dolorum commodi
              veritatis nemo ipsam, molestiae, sit recusandae reiciendis
              consequatur? Reiciendis fuga totam neque!
            </p>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Officiis
              exercitationem assumenda repudiandae repellat mollitia voluptates
              architecto minus minima, in dolores ex modi natus aspernatur iusto
              id a omnis magnam nobis! Deserunt consequuntur aliquam placeat
              omnis delectus reprehenderit, quam neque tempore itaque ex
              repudiandae cumque quia id, magni sit, enim et!
            </p>
          </div>
        </div>
      </section>
